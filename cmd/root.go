...
import (
	...
	"github.com/hen-chow/tweetBank/config"
)
...
var RootCmd = &cobra.Command{
	Use:               "tweetBank",
	Short:             "tweetBank loves your data",
	Long:              "tweetBank loves your data",
...
func init() {
	...
	pflags.StringVarP(
		...
		"configuration file (eg. /etc/tweetBank/tweetBank.yml)",
	)
